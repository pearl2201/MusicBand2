...
*/
            ...
            */
            ...
            if (!info.Exists)
            {
                throw new MidiFileException("File " + filePath + " does not exist", 0);
            }else
            {
            ...
            if (info.Length == 0)
            {
                throw new MidiFileException("File " + filePath + " is empty (0 bytes)", 0);
            }else
            {
            ...
            if (filePath.Contains(":/"))
            {
                ...
                Debug.Log("data.length: " + www.bytes.Length);
                data = www.bytes;
